...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center px-4 sm:px-6">
      <div className="w-full max-w-6xl h-full md:max-h-[90vh] flex flex-col md:grid md:grid-cols-2 rounded-2xl shadow-2xl overflow-hidden bg-gray-800 border border-gray-700">
        ...
        <div className="hidden md:flex flex-col justify-between p-10 bg-gradient-to-br from-purple-900 via-indigo-900 to-black relative overflow-hidden">
          {/* FX + Features (unchanged) */}
          <!-- your animated branding stuff remains unchanged here -->
        </div>
