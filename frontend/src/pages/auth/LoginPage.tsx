...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex">
      ...
      <div
        className="md:flex flex-col justify-between p-6 md:p-8 lg:p-12 bg-gradient-to-br from-purple-900 via-indigo-900 to-black relative overflow-hidden"
        style={{ width: '50%' }}
      >
        {/* Background Effects */}
      ...
      <div
        className="flex flex-col justify-center w-full p-6 md:p-8 lg:p-10 bg-gray-800 overflow-y-auto"
        style={{ width: '50%' }}
      >
