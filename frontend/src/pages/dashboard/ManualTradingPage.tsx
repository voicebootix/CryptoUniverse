          ...
          case 'opportunity': {
            ...
            const validated: Opportunity[] = opportunities.map((opp: any) => {
              ...
              return {
                ...
                stop_loss: opp.metadata?.stop_loss || 0,
                take_profit: opp.metadata?.take_profit || 0,
                suggested_position_size: opp.required_capital_usd || 0,
                position_size_percent: opp.metadata?.position_size_percent || 5,
                max_risk: opp.metadata?.max_risk_usd || 0,
                max_risk_percent: opp.metadata?.max_risk_percent || 2,
                potential_gain: opp.profit_potential_usd || 0,
                potential_gain_percent: opp.metadata?.potential_gain_percent || 0,
                risk_reward_ratio: opp.metadata?.risk_reward_ratio || 0,
                ...
                validation: {
                  approved: true,
                  consensus_score: (opp.confidence_score || 0) * 100,
                  confidence: (opp.confidence_score || 0) * 100,
